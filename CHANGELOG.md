...
## [0.4.0](https://github.com/albert20260301/altertable-lakehouse-cli/compare/altertable-lakehouse-cli-v0.3.0...altertable-lakehouse-cli-v0.4.0) (2026-05-27)


### Features

* bootstrap Lakehouse CLI (0.1.0) against specs v0.4.0 ([#1](https://github.com/albert20260301/altertable-lakehouse-cli/issues/1)) ([53200ec](https://github.com/albert20260301/altertable-lakehouse-cli/commit/53200ec7aa5e934752c38e9655a4d6b2e08359ee))
* **help:** improve help outputs ([#22](https://github.com/albert20260301/altertable-lakehouse-cli/issues/22)) ([4b7f362](https://github.com/albert20260301/altertable-lakehouse-cli/commit/4b7f362d205dfb88f95707356d9b1584a0c17dc8))


### Bug Fixes

* **debug:** actually implement --debug, add cURL verbosiness for further debug ([#16](https://github.com/albert20260301/altertable-lakehouse-cli/issues/16)) ([5fc8eae](https://github.com/albert20260301/altertable-lakehouse-cli/commit/5fc8eaec3d734f4a9e73857e0fb0da51509d8733))
* Fix append sending payload wrapped in single or batch payload ([#19](https://github.com/albert20260301/altertable-lakehouse-cli/issues/19)) ([3851dec](https://github.com/albert20260301/altertable-lakehouse-cli/commit/3851dec7593f94bb0d1fe9ee4f97977cb661f50b))
* Gracefully handle HTTP errors (Fixes [#3](https://github.com/albert20260301/altertable-lakehouse-cli/issues/3)) ([#4](https://github.com/albert20260301/altertable-lakehouse-cli/issues/4)) ([6ea82fa](https://github.com/albert20260301/altertable-lakehouse-cli/commit/6ea82fa965feb87f4e08860fdb059d90a27d0d6e))
* use http_request in cmd_validate to handle errors gracefully ([#6](https://github.com/albert20260301/altertable-lakehouse-cli/issues/6)) ([7eacb1a](https://github.com/albert20260301/altertable-lakehouse-cli/commit/7eacb1a8ba3e1f9bdd49abb462cab379859b8d55))
* **version:** ensure release-please updates the version ([#20](https://github.com/albert20260301/altertable-lakehouse-cli/issues/20)) ([26a711b](https://github.com/albert20260301/altertable-lakehouse-cli/commit/26a711b7e6cb38a99dea63f76896b95d4a7696b8))
